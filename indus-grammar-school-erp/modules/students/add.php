<?php
/**
 * Indus Grammar School ERP - Register Student
 * Version 1.0.0
 */

$pageTitle = 'Register Student';
$breadcrumbActive = 'Register Student';

// Boot application layout
include_once __DIR__ . '/../../includes/header.php';

// Verify permission
AuthMiddleware::requirePermission('student_create');
...
<div class="row mb-4 align-items-center">
    <div class="col-12">
        <h3 class="fw-bold text-secondary mb-0"><i class="fa-solid fa-user-plus me-2 text-primary"></i>Register New Student</h3>
        <p class="text-muted mb-0">Record a new student record manually in the school database system.</p>
    </div>
</div>
        ...
        <form id="add-student-form">
            ...
            <div class="row g-4 mb-4">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control bg-light" id="first_name" name="first_name" required placeholder="e.g. Zain">
                </div>
                <!-- Last Name -->
                <div class="col-md-6">
                    <label for="last_name" class="form-label fw-semibold small text-muted">Last Name <span class="text-danger">*</span></label>
                    <input type="text" class="form-control bg-light" id="last_name" name="last_name" required placeholder="e.g. Khan">
                </div>
                <!-- Gender -->
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <input type="date" class="form-control bg-light" id="enrollment_date" name="enrollment_date" value="<?php echo date('Y-m-d'); ?>" required>
                </div>
            </div>
            ...
            <div class="row g-4 mb-4">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control bg-light" id="guardian_name" name="guardian_name" required placeholder="e.g. Asif Khan">
                </div>
                <!-- Guardian Phone -->
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control bg-light" id="guardian_phone" name="guardian_phone" required placeholder="e.g. 03215551234">
                </div>
                <!-- Guardian Email -->
                <div class="col-md-4">
                    <label for="guardian_email" class="form-label fw-semibold small text-muted">Guardian Email (Optional)</label>
                    <input type="email" class="form-control bg-light" id="guardian_email" name="guardian_email" placeholder="e.g. guardian@gmail.com">
                </div>
                <!-- Address -->
                <div class="col-12">
...
<?php
// Inject validation and ajax submission scripts
$extraJS = '
<script>
